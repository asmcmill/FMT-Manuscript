...
pheatmap(MCBA_BSH_cor_plot,
         annotation_col=MCBA_BSH_anno%>%select(phylum),
         cluster_rows=F,
         cluster_cols=T,
         annotation_colors=list(phylum=anno_color$phylumplot[which(names(anno_color$phylumplot) %in% unique(c(MCBA_BSH_anno$phylum,BA_BSH_anno$phylum)))]),
         fontsize=12,
         breaks=seq(-1,1,2/60),
         color=c(rev(colorRampPalette(c("grey88","white","dodgerblue3"),bias=1)(30)),colorRampPalette(c("grey88","white", "red3"),bias=1)(30)),
