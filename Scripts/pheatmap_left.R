...
##Stolen from https://stackoverflow.com/questions/57729914/how-can-you-show-the-rownames-in-pheatmap-on-the-left-side-of-the-graph
                ...
                angle_col, gaps_row, gaps_col, ...) 
{
  ...
  gt = gtable::gtable(widths = unit.c(treeheight_row, rown_width,  
...
assignInNamespace(x="convert_annotations", value=convert_annotations, ns="pheatmap")
