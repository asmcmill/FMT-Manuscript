...
ggplot(data=bae_anno,aes(x=TIME.POINT.2,y=sum))+
  geom_jitter(aes(fill=TIME.POINT.2),shape=21,width=.2)+
...
```{r data export}
write_xlsx(list("S7A"=bae_anno,
                "S7A Wilcoxon signed rank"=bae_boxplot_stats,
                "S7B"=bae_species),
           "Excel Exports/Figure S7.xlsx")
