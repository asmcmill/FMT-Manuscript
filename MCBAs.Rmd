...
#list of aa significant by linear modelling
aa_names<-c("Tau"="Taurine","Gly"="Glycine","Ala"="Alanine","Ile_Leu"="Isoleucine/Leucine","Val"="Valine","Phe"="Phenylalanine","Trp"="Tryptophan","Tyr"="Tyrosine","Ser"="Serine","Glu"="Glutamate","His"="Histidine","Lys"="Lysine")
...
decon_order<-c("CA","CDCA","DCA","LCA","aMCA","bMCA","HCA","HDCA","7-keto DCA","EDCA","3-oxo LCA", "isoLCA","12-oxo LCA", "wMCA")
...
ggsave("Figures/MCBA/MCBA_Boxplots_Unconjugated.pdf",width=4.7, height=1.6)
